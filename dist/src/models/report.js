...
var Report = /** @class */ (function () {
     ...
     * @memberof Report
     */
    function Report(ip, message, configuration) {
        this.ip = ip;
     ...
     * @memberof Report
     */
    Report.prototype.send = function (callback) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axiosInstance.post(constants.reportPath, this.toJSON())];
                    case 1:
                        response = _a.sent();
                        if (response.status === 200 && response.data != null) {
                            ...
                            return [2 /*return*/, new Error("Failed to send report with error: " + response.data)];
                        }
                        return [2 /*return*/];
                }
            });
