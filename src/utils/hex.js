...
var Hex = /** @class */ (function () {
     ...
     */
    Hex.encodeTostring = function (str) {
     ...
     */
    Hex.validateNetworkIdentifier = function (str) {
    ...
    Hex.encode = function (str) {
        var _this = this;
        var value = this.toByteArray(str);
        var result = [];
        var count = 0;
        value.forEach(function (byte) {
            result[count] = _this.alphabet[byte >> 4];
            result[count + 1] = _this.alphabet[byte & 0x0f];
            count = count + 2;
        });
        return result;
    };
