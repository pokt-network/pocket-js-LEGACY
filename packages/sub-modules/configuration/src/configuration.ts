...
public readonly useLegacyTxCodec: boolean = LIMITER.use_legacy_tx_codec.default
 ...
 * @param {boolean} useLegacyTxCodec - (optional) If True the legacy tx codec will be used (AminoJS), false will use the new ProtoBuf encoding, default is true; default true.
...
constructor(
  ...
  useLegacyTxCodec: boolean = LIMITER.use_legacy_tx_codec.default
) {
