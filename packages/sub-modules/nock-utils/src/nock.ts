...
export class NockUtil {
   ...
   * @memberof NockUtil
   */
  public static mockRawTx(code = 200): nock.Scope {
   ...
   * @memberof NockUtil
   */
  public static mockDispatch(code = 200): nock.Scope {
   ...
   * @memberof NockUtil
   */
  public static mockBadDispatch(code = 400): nock.Scope {
   ...
   * @memberof NockUtil
   */
  public static mockRelayForConsensus(code = 200): nock.Scope {
    const relayResponse =
   ...
   * @memberof NockUtil
   */
  public static mockRelayForConsensusFailure(code = 200): nock.Scope {
    const relayResponse =
   ...
   * @memberof NockUtil
   */
  public static mockGetBlock(code = 200): nock.Scope {
    const block =
  ...
  public static mockGetAccount(code = 200): nock.Scope {
    const account =
  ...
  public static mockGetTx(code = 200): nock.Scope {
    const tx =
  ...
  public static mockGetTxFail(code = 200): nock.Scope {
    const tx =
  ...
  public static mockGetHeight(code = 200): nock.Scope {
  ...
  public static mockGetBalance(code = 200): nock.Scope {
  ...
  public static mockGetNodesWithJailedStatus(code = 200): nock.Scope {
    const nodes =
  ...
  public static mockGetNodesWithStakingStatus(code = 200): nock.Scope {
    const nodes =
  ...
  public static mockGetNode(code = 200): nock.Scope {
    const node =
  ...
  public static mockGetNodeParams(code = 200): nock.Scope {
    const nodeparams =
  ...
  public static mockGetApps(code = 200): nock.Scope {
    const apps =
  ...
  public static mockGetApp(code = 200): nock.Scope {
    const app =
  ...
  public static mockGetAppParams(code = 200): nock.Scope {
    const appParams =
  ...
  public static mockGetPocketParams(code = 200): nock.Scope {
  ...
  public static mockGetSupportedChains(code = 200): nock.Scope {
  ...
  public static mockGetSupply(code = 200): nock.Scope {
  ...
  public static mockChallenge(code = 200): nock.Scope {
  ...
  public static mockAccountTxs(code = 200): nock.Scope {
  ...
  public static mockAccountTxsWithProve(code = 200): nock.Scope {
    const accountTxs =
  ...
  public static mockBlockTxs(code = 200): nock.Scope {
  ...
  public static mockBlockTxsWithProve(code = 200): nock.Scope {
  ...
  public static mockGetAllParams(code = 200): nock.Scope {
    const allParams =
  ...
  public static mockGetNodeClaims(code = 200): nock.Scope {
    const nodeClaims =
  ...
  public static mockGetNodeClaim(code = 200): nock.Scope {
    const nodeClaim =
  ...
  public static mockGetUpgrade(code = 200): nock.Scope {
  ...
  public static mockRelayResponse(code = 200): nock.Scope {
