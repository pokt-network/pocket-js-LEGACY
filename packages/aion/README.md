...
<h1 align="left">PocketJS Aion</h1>
...
PocketJS Aion wraps all of the tools a developer will need to begin interacting with the Aionereum network.
...
The PocketJS Aion package is hosted in [NPM](https://npmjs.com), see below how to install.

`npm install --save pocket-js-aion`

<h1 align="left">Usage</h1>

If you would like to know how to integrate PocketJS Aion into your DApp, [visit our developer portal](https://pocket-network.readme.io) that has a lot of useful tutorials and material about the Pocket Network.
